...
--
-- Replays 0118's version of expire_stale_holds() verbatim with one arm added,
...
begin
  ...
  -- 0125: drop rate limit windows older than a day. Same sweep, one more arm.
