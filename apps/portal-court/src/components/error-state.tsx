 ...
 * (loading, empty, populated, error per PRD-03 section 3 and CLAUDE.md's
 * phase gate rule). Pairs with EmptyState's visual language (dashed card,
 * centered icon) but in the danger tone, with a retry action when the
 * caller has one.
 */
