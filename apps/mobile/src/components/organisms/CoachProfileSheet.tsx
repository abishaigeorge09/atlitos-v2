...
export function CoachProfileSheet({
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.surface, borderTopLeftRadius: 28, borderTopRightRadius: 28 }}>
      <ScrollView contentContainerStyle={{ padding: spacing.lg, gap: spacing.xl }}>
        <View style={[styles.row, { gap: spacing.md }]}>
          <View style={{ height: 80, width: 80, borderRadius: 999, backgroundColor: colors.surfaceMuted, overflow: 'hidden' }}>
        ...
        <View style={{ gap: spacing.sm }}>
          <Text style={[textStyle('overline'), { color: colors.textTertiary }]}>Specialization</Text>
        ...
        <View style={{ gap: spacing.sm }}>
          <Text style={[textStyle('overline'), { color: colors.textTertiary }]}>Sessions offered</Text>
          {sessionsOffered.map((session) => (
            ...
            >
              <View>
                ...
                <Text style={[textStyle('caption'), { color: colors.textTertiary }]}>{session.duration}</Text>
              </View>
        ...
        <View style={{ gap: spacing.sm }}>
          <Text style={[textStyle('overline'), { color: colors.textTertiary }]}>Availability</Text>
          <View style={[styles.row, { flexWrap: 'wrap', gap: spacing.sm }]}>
        ...
        <View style={{ gap: spacing.sm }}>
          <Text style={[textStyle('overline'), { color: colors.textTertiary }]}>Pricing</Text>
