...
/**
 * Dev-only components showcase. Not a real app screen, linked from the Home
 * tab in __DEV__ only (see (tabs)/index.tsx). Originally the Phase 1 spike's
 * root screen (docs/phases/PHASE-1-SPIKE.md), moved here once real
 * auth/onboarding routing took over "/".
 */
