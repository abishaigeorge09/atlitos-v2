import { requireVerifiedApplication, type WishlistItem } from "@/lib/empower";
...
// sponsor donation reflects here without a manual refresh (FR-15).
export default async function WishlistPage() {
  ...
  return <WishlistManager upaId={application.id} initialItems={(data ?? []) as WishlistItem[]} />;
}
