 ...
 * rerun this script instead: `pnpm --filter @atlitos/portal-life gen-tokens`.
 *
...
const slotToColorToken: Record<string, string> = {
  ...
  "primary-foreground": "color-accent-ink",
  ...
  "sidebar-primary-foreground": "color-accent-ink",
 ...
 * Regenerate with: pnpm --filter @atlitos/portal-life gen-tokens
