...
- [x] `AT-148` AT-88 refund surfaced to cancelled-session athlete, PRD-02 FR-35 (sonnet) DONE (Track E, `p8/track-e-debt`)
- [x] `AT-149` show_donor_name finalize-time snapshot + read path, PRD-05 FR-17 (opus, money-path) DONE (Track E, `0066`)
- [x] `AT-150` carried verifications: AT-25 date filter, AT-26 sweep coverage, AT-73 late-capture, TS skew (sonnet) DONE (Track E, see disposition below)
